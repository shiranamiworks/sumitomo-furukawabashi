    ...
    <div class="wrap">
      ...
      <ul class="lists list01">
        <li>
          ...
          <p class="mini">非常用エレベーター のみとなります。</p>
        </li>
        <li>
      ...
      <ul class="lists list02">
        ...
        <li>
          ...
          <p class="lead">災害時などに安全に避難できるようエントランス、41階エレベーターホールのオートドアには、強化ガラスを採用しました。</p>
        </li>
        <li>
        ...
        <li>
          ...
          <p class="lead">万一の火災に備えて、消防隊の迅速な消火活動をバックアップするために、敷地外構の地中に約40ｔの水を貯めることができる防火水槽を設置しています。</p>
        </li>
        <li>
          <p class="tit-img">防災用井戸<span>（予定※1）</span></p>
          <p class="lead">災害時に水道や電気などのライフラインが停止しても、非常用マンホールトイレ洗浄水を確保できる防災用の井戸を敷地内に設置する予定です（※1）。<br><span>※1.掘削状況により計画を中止・変更する場合があります。くわしくは係員にお尋ねくだい。※飲料水としては使用できません。※被災の状況により水が使えない場合があります。</span></p>
        </li>
        <li>
