...
<main>
  ...
  <div class="equipment-link equipment-link--5">
    ...
    <a href="equipment03.html" class="current"><p>健康・エコ・省エネ</p></a>
  ...
  <section class="sections sec01 clearfix">
    <div class="wrap">
      ...
      <ul class="lists list00">
        <li class="full">
        <p class="tit-img">エネファーム</p>
          <p class="lead">自家発電で叶える、快適で豊かな暮らし。エネファームは、１台で電気もお湯も創るコージェネレーションシステム。お湯づくりには発電時の廃熱を利用し、エネルギーをムダにしません。</p>
          <div class="image full">
            <img src="./images/equipment02/img01.jpg" alt="" class="pc"><img src="./images/equipment02/img01-sp.jpg" alt="" class="sp">
          </div>
        </li>
      </ul>
      <ul class="lists list00">
        ...
        <p class="tit-img">24時間機械給気システム</p>
          <div class="text">
            <p class="lead">窓を閉めたままでも常に換気ができる、24時間換気システムを採用しています。機械給気により外気を各室に取入れ、室内の空気は機械で排気します。給気ファン内のフィルターで一定のホコリ・ちりを低減します。</p>
          </div>
          <div class="image">
            <img src="./images/equipment02/img07.jpg" alt="" class=""><p class="annotation gothic">（参考写真）</p>
          </div>
        </li>
      </ul>
      <ul class="lists list00">
        ...
        <p class="tit-img">大阪ガス温水床暖房</p>
          <div class="text">
            ...
            <p class="lead lead01">理想的な頭寒足熱で、足元ポカポカ。</p>
            <p class="lead">床面が約25℃、お部屋全体は約20℃前後という理想的な暖房で、長時間暖房しても頭がボーッッとしたり、のぼせたりしません。<br><span>※仕上げ材、建物の構造や断熱性能等により床面温度、室温は異なります。</span></p>
          </div>
          <div class="image">
            <img src="./images/equipment02/img13.jpg" alt="" class=""><p class="annotation gothic">（参考写真）</p>
          </div>
        </li>
      </ul>
      ...
      <ul class="lists list03">
        <li>
          ...
          <p class="lead">キッチンとバスルームの給湯モコンには「エコ運転機能」を搭載。画面メニューから「エコ」をタッチするだけで給湯量が自動調整でき、省エネ・節約に効果的です。また、エネファームで使用した一日のガス・お湯の量、使用料金の目安、ＣO2の排出量を表示する「エネルック機能」も付いています。<br><span>※「エコ運転機能」を利用して2ヶ所以上でお湯を使うと湯細りする可能性があります。</span></p>
          <div class="image size tb">
            <img src="./images/equipment02/img02.jpg" alt="" class="">
            <p class="annotation gothic">（参考写真）</p>
          </div>
      ...
      <ul class="lists list08">
        ...
        <li>
          ...
          <p class="lead">外気に面する柱・梁・壁の室内側に約25㎜～約50㎜厚、最下階住戸の床下に約20㎜～約45㎜厚の断熱材を施工。また、屋上には約50㎜厚の断熱材を施しています。<br>※断熱材施工範囲は各住戸により異なります。 詳細は係員にお尋ねください。</span></p>
        </li>
        <li>
        ...
        <li>
          ...
          <p class="lead">シャワーヘッドに付いたボタンを押すだけで、吐水・止水を繰り返すことができ大変便利です。また、スプレー式（節水）のシャワーヘッドなので従来品と比較すると最大約48％＜㈱LIXIL比＞節水効果もあります。<br><span>※3階～40階住戸はLIXIL製。※41階住戸はパナソニック製で、従来のシャワーと比較すると最大44％〈パナソニック㈱比〉節水となります。</span></p>
        </li>
      </ul>
    </div>
  </section><!-- sec01 -->
