  ...
  <section class="sections sec02 clearfix">
    <div class="wrap">
      ...
      <li>
        ...
        <li>
          <p class="tit-img">全自動タイプ<span>（リモコン通話機能付）</span></p>
          <div class="image">
        ...
        <li>
          ...
          <p class="lead">カウンターとボウルはお手入れのしやすい継ぎ目のない一体成形で、美しい光沢の有機ガラス系新素材仕様。<br><span>※41階住戸タイプを除く</span></p>
          <div class="image tb">
            <img src="./images/equipment02/img06.jpg" alt="" class="">
          </div>
        </li>
      ...
      <li>
        ...
        <li>
          <p class="tit-img">手洗いカウンター付トイレ</p>
          <p class="lead">トイレには、高級感あふれる天然石仕上げの手洗いカウンターを設けています。<br><span>※DD-3、DG-3タイプのみ。</span></p>
        </li>
      </ul>
    </div>
  </section><!-- sec02 -->
