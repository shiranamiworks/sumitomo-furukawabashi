...
<main>
  ...
  <section id="contents-sec" class="ma_to50">
    <div class="container">
      ...
      <div class="contents-link">
        ...
        <a href="https://www.sumitomo-rd-mansion.jp/kansai/furukawabashi/list.php" target="_blanc">         
          <figure><img src="./images/top/img_plan.jpg" alt="間取り"></figure>
            <div class="contents-link__ttl">
              <p class="f-en">PLAN</p>
              <h3>間取り</h3>
             </div>
  ...
  <div class="container ma_to20 ma_bo20">
    <p class="caption">※1.1995年1月～2023年6月までに門真市内で新規供給された分譲マンションのうち、本プロジェクトの総戸数648戸は過去最大規模の戸数であり、41階建ては過去最高層となります。（有）MRC調べ（2023年9月現在）<br>※2.官民一体駅前大規模複合開発とは、門真市幸福東土地区画整理事業[2025年度事業完了予定 出典：大阪府ホームページ(2023年9月時点)]のことであり、本物件販売対象はタワー棟、民間施設棟、多目的広場となります。なお、賑わいの輪、(仮称)門真市立生涯学習複合施設等は本物件のものではありません。あらかじめご了承ください。<br>※3.距離表示については地図上の概測距離を、徒歩分数表示については80ｍを1分として算出し、端数を切り上げたものです。掲載の徒歩分数は2023年10月現在のものです。「門真市幸福東土地区画整理事業」（事業主：門真市幸福東土地区画整理組合）に伴う地区外道路4号線および交流広場・交通広場の整備（2026年度事業完了予定）により徒歩分数・ルートが変更になる予定です。また、地区外道路4号線および交流広場・交通広場は門真市の所有であり、「シティタワー古川橋」の竣工時に完成していない可能性があります。あらかじめご了承ください。<br>※4. 京阪本線「古川橋」駅より京阪本線区間急行利用（平常時：京阪本線区間急行利用、「守口市」駅で京阪本線準急に乗換）<br>※5. 京阪本線「古川橋」駅より京阪本線区間急行利用、「京橋」駅でJR大阪環状線に乗換（平常時：京阪本線利用、「守口市」駅で京阪本線準急に乗換、「京橋」駅でJR大阪環状線紀州路快速に乗換）<br>※掲載の所要時間は待ち時間・乗り換え時間を含んだ通勤時（カッコ内は平常時）の目安であり、時間帯により多少異なります。<br>※掲載の完成予想図は計画段階の図面を基に描き起こしたもので、実際とは多少異なります。また、形状の細部および設備機器等については省略しております。<br>※外構・植栽計画は今後変更される場合がありますので、あらかじめご了承ください。<br>※敷地内の樹木等はある程度生育した後をイメージして描いたものです。また、葉や花の色合い、樹形等はイメージであり実際とは異なります。なお、植栽計画は変更される場合がありますので、あらかじめご了承ください。</p>
  </div>
