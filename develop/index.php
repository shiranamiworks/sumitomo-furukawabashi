...
※3. 1995年1月～2023年6月までに門真市内で新規供給された分譲マンションのうち、本プロジェクトの総戸数648戸は過去最大規模<br>の戸数であり、41階建ては過去最高層となります。（有）MRC調べ（2023年9月現在）<br>
※4. 京阪本線「古川橋」駅より京阪本線区間急行利用（平常時：京阪本線区間急行利用、「守口市」駅で京阪本線準急に乗換）
...
※敷地内の樹木等はある程度生育した後をイメージして描いたものです。また、葉や花の色合い、樹形等はイメージであり実際とは異なります。なお、植栽計画は変更される場合がありますので、あらかじめご了承ください。</p>
  </div>
