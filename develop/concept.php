  ...
  <div class="sections images">
    ...
    <div class="texts tb">
      <div class="inner">
        ...
        <p class="lead">新しい街区のシンボルとなるのは、門真市内最大・最高層<sup>※3</sup>を誇る地上41階・全648邸のタワーレジデンス。<br>広大なエリア内には、魅力的な広場や【愛称：KADOMADO（カドマド）】<sup>※4</sup>なども配置。多様な人々が訪れ、交流し、いつの日もたくさんの笑顔にあふれる街が、門真市の未来をリードしていきます。</p>
      </div>
    </div>
    ...
    <div class="texts">
      <div class="inner">
        ...
        <p class="lead">この街での暮らしにさらなる豊かさをもたらすのが、【愛称：KADOMADO（カドマド）】<sup>※4</sup>です。立体的な緑に包まれた建物には図書館と文化会館などを集約。洗練された文化と学びの交流拠点として、住む人と訪れる人の心地よいコミュニティを育んでいきます。</p>
      </div>
    </div>
    ...
    <p class="caps">【愛称：KADOMADO（カドマド）】外観イメージ<br>※実際のイメージとは異なります。<br>【愛称：KADOMADO（カドマド）】（事業主：門真市）は本物件敷地外の施設となります。</p>
  </div>
