...
<main>
  ...
  <section class="sections area clearfix">
    <div class="inner">
      ...
      <p class="mini">※1.「（仮称）松生町」駅／2033年度開業目標 出典：大阪モノレール（株）ホームページ（2025年2月現在）</p>
    </div><!-- inner -->
  </section><!-- area -->
  ...
  <section class="sections project clearfix">
    <div class="inner">
      ...
      <p class="lead">門真市のビジョンに呼応する一大プロジェクトが動きはじめた「古川橋」駅前に誕生するのは、<br class="pc">地上41階・総戸数648戸のタワーをシンボルとする壮大な駅前街区。<br>（仮称）門真市立生涯学習複合施設【愛称：KADOMADO（カドマド）】や多彩な交流の場を複合した街区から、<br class="pc">あたらしい日々が幕を開けます。</p>
    </div><!-- inner -->
    <div class="image">
    ...
    <div class="design clearfix">
      ...
      <ul class="column02 ring">
        ...
        <li>
          ...
          <div class="image">
            ...
            <p class="annotation white">外観完成予想CG</p>
          </div>
      ...
      <p class="caps">※学びの輪・外観完成予想CGは計画段階の図面を基に描き起こしたものに人物等をCG合成したもので、実際とは多少異なります。また、形状の細部および設備機器等については省略しております。<br>※外構・植栽計画、家具・調度品の形状・色等は今後変更される場合がありますので、あらかじめご了承ください。</p>
      </div><!-- inner -->
    </div><!-- design -->
  </section><!-- project -->
  ...
  <section class="sections facility clearfix">
    <div class="inner">
    <p class="tit">（仮称）門真市立生涯学習複合施設<br>＜愛称：KADOMADO（カドマド） ＞ <br class="sp tb"><span>【2025年度完成予定】</span></p>
    <div class="content">
      <p class="text">地域一体のコミュニティを育む文化と学びの交流拠点。</p>
      <p class="lead">タワーマンションの南東側には、<br class="pc">カルチュア・コンビニエンス・クラブ株式会社が運営する生涯学習複合施設が誕生予定。<br>図書館や文化会館の機能があり、<br class="pc">吹き抜けを中心に立体的につながる開放的な空間と、<br class="pc">建物の外部空間を緑で囲むスパイラルガーデンにより、<br class="pc">周辺に心地よい賑わいと潤いをもたらします。</p>
      <div class="image img01">
      <img src="./images/location01/facility01.jpg" alt="">
      <p class="annotation">外観イメージ</p>
      </div>
      <div class="white-bg">
        <ul class="column02 list01">
          ...
          <li>
            ...
            <p class="annotation">内観完成予想CG【提供画像】<br>出典：門真市ホームぺージ （仮称）門真市立生涯学習複合施設整備工事実施設計概要書</p>
          </li>
        </ul>
        </div><!-- white-bg -->
        <p class="caps">※実際のイメージとは異なります。</p>
        ...
        <ul class="column02 list02">
          ...
          <li>
            <div class="text">
              <p class="txt01">健やかな光と風に満ちた<br class="pc">吹き抜けが気持ちいい内部空間。</p>
              <p class="txt02">施設の内部には、4層を貫く贅沢な吹き抜け空間が広がります。上部のトップライトから降り注ぐ自然光と採風窓がもたらす清涼な空気が、個性的なテーマに基づいてデザインされたそれぞれのフロアを優しく包み込みます。 </p>
            </div>
            <div class="image pc">
              <a class="js-modal-open none" href="" data-target="modal01">
            ...
            <div class="modal__bg js-modal-close"></div>
              <div class="modal__content">
                <div class="image popup">
                   <img src="./images/location01/facility05.jpg">
                   <p class="annotation">概念図</p> 
                </div>
            ...
            <div class="image tb">
					    <div class="swipe-img modify-starts">
						    <img src="images/location01/facility05.jpg" alt="概念図">
              </div>
              <p class="annotation">概念図</p>
            </div>
          ...
          <li>
            <div class="text">
              <p class="txt01">カルチュア・コンビニエンス・クラブ株式会社</p>
              <p class="txt02">「図書館を新しく 地域を面白く」。ゆったりとした読書を楽しめる。本を借りなくてもほっとできる空間がある。<br>市の皆さんが行きたくなる、幸せになるそんな図書館を目指し多くの施設をプロデュースしてきたカルチュア・コンビニエンス・クラブ株式会社。<br>図書館という教育施設の役割のみならず地域の賑わいづくりにも寄与しています。 </p>
            </div>
            <div class="image">
