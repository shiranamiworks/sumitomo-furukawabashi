...
<main>
  ...
  <section class="sections project clearfix">
    <div class="inner">
      ...
      <p class="lead">門真市のビジョンに呼応する一大プロジェクトが動きはじめた「古川橋」駅前に誕生するのは、<br class="pc">地上41階・総戸数648戸のタワーをシンボルとする壮大な駅前街区。<br>【愛称：KADOMADO（カドマド）】や多彩な交流の場を複合した街区から、あたらしい日々が幕を開けます。</p>
    </div><!-- inner -->
    <div class="image">
  ...
  <section class="sections facility clearfix">
    <div class="inner">
    <p class="tit">＜愛称：KADOMADO（カドマド） ＞ <br class="sp tb"><span>【2025年度完成予定】</span></p>
    <div class="content">
